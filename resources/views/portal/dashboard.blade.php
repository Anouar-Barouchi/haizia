            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6">
                    <form action="{{ route('portal.submit_photos') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-8">
                            <label class="block text-gray-700 font-semibold mb-2" for="photo">الصورة النهائية (صورة واحدة فقط)</label>
                            <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center">
                                        <label for="photo" class="relative cursor-pointer bg-white rounded-md font-medium text-emerald-600 hover:text-emerald-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-emerald-500">
